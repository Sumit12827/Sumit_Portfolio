    ...
    <div className="w-full flex flex-col items-center gap-8">
      ...
      >
        <div className="flex flex-wrap justify-center gap-8">
          {/* GitHub */}
          <a href="https://github.com/Sumit12827" target="_blank" rel="noopener noreferrer" className="social-icon github">
          ...
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/sumit-375534294/" target="_blank" rel="noopener noreferrer" className="social-icon linkedin">
            <div className="icon-container">
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-8 w-8 text-white">
          ...
          {/* Email */}
          <a href="mailto:sumitdowney@gmail.com" className="social-icon email">
            <div className="icon-container">
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-8 w-8 text-white">
                <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.442.166-.977.484-1.293L12 12.48 23.516 4.164c.318.316.484.851.484 1.293z"/>
              </svg>
            </div>
